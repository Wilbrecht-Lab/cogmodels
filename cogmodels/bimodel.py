...
class BIModel(BayesianModel):
    ...
    def id_param_init(self, params, param_id):
        varp_list = ["p_rew", "sw", "beta", "st"]
        fixp_list = ["b0", "w0", "p_eps", "gam"]
        p_rew, sw, beta, st = params.loc[params["ID"] == param_id, varp_list].values.ravel()
...
class BI_log(BIModel):
    ...
    def id_param_init(self, params, param_id):
        ...
        sw, beta, st = params.loc[params["ID"] == param_id, varp_list].values.ravel()
...
class BRL_pr(BIModel):
    ...
    def id_param_init(self, params, param_id):
        ...
        sw, beta, st, p_rew = params.loc[params["ID"] == param_id, varp_list].values.ravel()
...
class BRL_wrnb(BIModel):
    ...
    def id_param_init(self, params, param_id):
        ...
        sw, st, wr0, alpha = params.loc[params["ID"] == param_id, varp_list].values.ravel()
...
class BRL_fwr(BIModel):
    ...
    def id_param_init(self, params, param_id):
        ...
        sw, st, alpha, beta = params.loc[params["ID"] == param_id, varp_list].values.ravel()
